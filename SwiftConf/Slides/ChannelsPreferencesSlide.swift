...
I find these very interesting because if you look at the PreferenceKey protocol, only one type conforms to it
If you look at the documentation it says "Don’t use this"

And yet there are 11 view modifiers that you can use to interact with preferences
...
If we look at the available modifiers we can spot a pattern called a Responder Chain
